...
if __name__ == '__main__':
    ...
    plot_difference(dr_healthy=dr_high_gba, dr_disease=dr_low_gba, title='GBA: Disease - Healthy')
    plot_difference(dr_healthy=dr_low_mutant_lrrk2, dr_disease=dr_high_mutant_lrrk2, title='LRRK2: Disease - Healthy')
